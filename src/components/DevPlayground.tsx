...
const DEV_PROJECTS: DevProject[] = [
  {
    ...
    description:
      "An interactive Rive-powered weapon customizer with real-time part swapping and state machine logic — no AI, pure craftsmanship.",
        ...
        {DEV_PROJECTS.map((project) => {
          ...
          return (
            <motion.a
              ...
              className="col-span-4 max-sm:col-span-4 group relative block overflow-hidden cursor-pointer"

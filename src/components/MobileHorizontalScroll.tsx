...
export default function MobileHorizontalScroll({
  ...
  return (
    <div
      data-lenis-prevent
      className={`overflow-x-auto overscroll-x-contain snap-x snap-mandatory touch-pan-x [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden ${className}`}
    >
